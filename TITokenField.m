...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    CGFloat width = (_maxWidth - hTextPadding - accessoryWidth);
    NSDictionary *attributes = @{NSFontAttributeName:_font, NSParagraphStyleAttributeName: paragraphStyle};
    NSAttributedString *attributedText = [[NSAttributedString alloc] initWithString:_title attributes:attributes];
    CGRect stringRect = [attributedText boundingRectWithSize:(CGSize){width, CGFLOAT_MAX} options:NSStringDrawingUsesLineFragmentOrigin context:nil];
